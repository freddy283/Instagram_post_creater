...
export default function ConnectInstagram() {
  ...
  useEffect(() => {
    ...
    // If returning from OAuth callback
          ...
          <div className="glass rounded-2xl p-6 space-y-4">
            <div className="flex items-center gap-3 p-4 rounded-xl"
              ...
              <div className="text-sm" style={{ color: 'var(--text-2)' }}>
                Instagram API not configured on this server. Ask the admin to add{' '}
                <code style={{ color: 'var(--gold)' }}>INSTAGRAM_APP_ID</code> and{' '}
                <code style={{ color: 'var(--gold)' }}>INSTAGRAM_APP_SECRET</code> to the backend .env file.
              </div>
            </div>
            <p className="text-sm" style={{ color: 'var(--text-2)' }}>
              You can still use Aureus — generate videos and download them to post manually.
            </p>
